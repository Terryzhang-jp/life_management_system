...
import { Plus, X, Edit2, Save, Loader2, ArrowLeft, Expand, ChevronRight, HelpCircle } from "lucide-react"
...
export default function TasksPage() {
  ...
  const TaskItem = ({
    ...
    return (
      <div className={`p-3 border rounded-lg transition-colors hover:opacity-80 ${getPriorityColor(task.priority || 999)}`}>
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              {task.isUnclear && (
                <HelpCircle
                  ...
                  title={task.unclearReason || "此任务标记为模糊"}
                />
              )}
                    ...
                    {subTasks.map((subTask) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              {subTask.isUnclear && (
                                <HelpCircle
                                  className="h-4 w-4 text-orange-500"
                                  title={subTask.unclearReason || "此任务标记为模糊"}
                                />
                              )}
                          ...
                          <DateDisplay date={subTask.deadline} className="mt-1" />
                        </div>
                      )
                    })}
                    {subTasks.length === 0 && (
                      ...
                      subSubTasks.length > 0 ? (
                        subSubTasks.map((subSubTask) => {
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <span className="font-medium">{subSubTask.title}</span>
                                <div className="flex items-center gap-1">
                              ...
                              <DateDisplay date={subSubTask.deadline} className="mt-1" />
                            </div>
                          )
                        })
                      ) : (
